...
if(!etiketlenenKişi) return message.channel.send(`${ayarlar.no} **Tagsız vermek için bir kişi etiketlemelisin!**`).then(message.react(client.emojis.cache.get(ayarlar.no)))

...
message.channel.send(arwEmbed.setDescription(`Kullanıcı başarıyla kayıtsıza (<@&${ayarlar.kayıtsızRol}>) atıldı!`)).then(x => x.delete({ timeout: 31000 })).then(message.react(client.emojis.cache.get(ayarlar.yes))) //Youtube Matthe

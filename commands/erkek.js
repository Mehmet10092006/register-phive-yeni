...
.setColor("RANDOM")
.setDescription(`Kullanıcının ismini \`✦ ${isim} ${ayarlar.sembol} ${yaş}\` olarak değiştirdim ve ona <@&${ayarlar.erkekRol1}>, <@&${ayarlar.erkekRol2}> rollerini verdim! <a:mad_mavitik:903541942254718976>`)
...
client.channels.cache.get(ayarlar.sohbetKanal).send(`${etiketlenenKişi} **Hoşgeldin!** <a:874992144002207854:907636369495576606>`).then(x => x.delete({ timeout: 31000 }))
